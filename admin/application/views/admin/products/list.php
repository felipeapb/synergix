          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="green header">Sobrenome</th>
                <th class="red header">Email </th>

                <th class="red header">Ação</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              foreach($products as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/products/update/'.$row['id'].'" class="btn btn-info">Ler </a>
                  <a href="'.site_url("admin").'/products/delete/'.$row['id'].'" class="btn btn-danger">Apagar</a>
                </td>';
                echo '</tr>';
              }
              ?>
